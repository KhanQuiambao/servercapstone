    ...
    <div className='d-flex flex-column align-items-center pt-4'>
			...
			<form className="row g-3 w-50" onSubmit={handleSubmit}>
				...
				<div className="col-12">
					...
					<input type="tel" className="form-control" id="inputPhone4" placeholder='Enter Number' autoComplete='off' onChange={e => setData({...data, phoneNo: e.target.value})}/>
				</div>
				<div className="col-12">
					<label for="inputEmail4" className="form-label">Email</label>
					<input type="email" className="form-control" id="inputEmail4" placeholder='Enter Email' autoComplete='off' onChange={e => setData({...data, email: e.target.value})}/>
				</div>
				<div className="col-12">
				...
				<div classNames="col-12">
					...
					<input type="text" className="form-control" id="inputAddress" placeholder="1234 Main St" autoComplete='off' onChange={e => setData({...data, address: e.target.value})}/>
				</div>
